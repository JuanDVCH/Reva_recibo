...
@section('content')
    <div class="container mt-5">
        <h2 class="text-center mb-4">Crear formato de etiqueta</h2>
        <form id="etiquetaForm" method="POST" action="{{ route('etiqueta.store') }}" class="row g-3">
            @csrf
    ...
    <div class="text-center mt-3">
        <a href="{{ route('etiqueta.index') }}" class="btn btn-secondary ml-2">Volver Atrás</a>
    </div>
    </div>
@endsection
