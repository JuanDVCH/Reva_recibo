    ...
    <div class="container mx-auto my-8 bg-white p-8 rounded-md shadow-lg">
        ...
        <form method="post" action="{{ route('users.update', ['user' => $user->id]) }}"
            ...
            <div class="flex justify-end mt-4">
                <button type="submit" class="bg-teal-500 text-white px-4 py-2 rounded-md mr-2">Actualizar
                    Usuario</button>
                <button type="button" class="bg-red-500 text-white ml-2 px-4 py-2 rounded-md hover:underline"
                    onclick="clearForm()">Limpiar</button>
                <button type="button"
                    class="text-gray-500 hover:text-gray-700 ml-2 px-4 py-2 rounded-md hover:underline"
